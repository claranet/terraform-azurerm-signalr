...
those errors from plan time to apply time. The `diagnostic-settings` submodule moves to `~>
9.0`, which requires AzureRM `~> 5.0` as well.

### Features

* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) e21605f

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 c6fa48a
* **deps:** update dependency tflint to v0.64.0 3fadd19
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 2134016
* **v9:** 🐛 synchronize common files and docs a085118

## 8.0.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug d8602fe

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 2163345
* **deps:** update dependency opentofu to v1.12.2 1b80ffd
* **deps:** update dependency opentofu to v1.12.3 6cd95a2
* **deps:** update dependency opentofu to v1.12.4 d56ae7d
* **deps:** update dependency tflint to v0.63.1 5c05a21
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 479ec7f
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 ad9bd55
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 7b8dbee
* **deps:** update tools 46ae9d7

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 4376ade

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu f971c6a
* **deps:** update dependency terraform-docs to v0.23.0 0c953ee
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 f79e213
* **pre-commit:** 🔧 move to prek 681105f
* **tfdocs:** bump tfdocs to v0.22 🔧 21212be

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 81f44c4

### Code Refactoring

* update module structure and Github actions 👷 45dfa91

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing fa09a59
* **deps:** 🔗 bump tflint rules version 6335e2f
* **deps:** update dependency trivy to v0.69.2 ca84835
* **deps:** update dependency trivy to v0.69.3 0843325
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 f307c09
